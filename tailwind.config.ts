  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        strong:
          '0 0 40px rgba(0, 229, 255, 0.45), 0 0 120px rgba(0, 170, 255, 0.18)',
      },
      backgroundImage: {
        'grid-radial':
          'radial-gradient(circle at top, rgba(0,229,255,0.12), transparent 44%), linear-gradient(rgba(0,229,255,0.08) 1px, transparent 1px), linear-gradient(90deg, rgba(0,229,255,0.08) 1px, transparent 1px)',
      },
      fontFamily: {
